...
class TutorialSpeech {
  ...
  async speakScene(scene) {
    ...
    console.log('[TTS] speakScene', { sceneId: scene.id, currentLang, hasNarrationText: Boolean(narrationText), voiceAvailableForLang: hasVoiceForLang, textPreview: text.slice(0, 100) });
